  ...
  <div class="project pa-4">
                ...
                <tr>
                  ...
                  <td>
                    <template>
                      <Operations
                        :operations="[
                          { text: $vuetify.lang.t('$vuetify.lang_menu_apply_new_project_envs'), onClick: () => {openNewEnv(project.tenantCode)}},
                          { text: $vuetify.lang.t('$vuetify.lang_menu_apply_update_project'), onClick: openUpdateProject },
                          { text: $vuetify.lang.t('$vuetify.lang_menu_apply_delete_project'), onClick: () => {deleteProjectDialog = true} },
                        ]"
                        color="yellow"
                      />
                    </template>
                ...
                <v-card class="rounded-0">
                  <v-card class="rounded-0">
                    <v-card-title>
                      ...
                      <v-spacer></v-spacer>
                      <v-btn color="yellow" small class="my-1" @click="openQuotaConfig(item.envName)">{{ $vuetify.lang.t('$vuetify.lang_menu_apply_update_resource_quota') }}</v-btn>
                    </v-card-title>
                    <v-card-text>
                    ...
                    <v-card-text class="info-table">
                      ...
                      >
                        ...
                        <template v-slot:item.deploymentYaml="{ item }">
                          <v-btn v-if="item.deploymentYaml" small color="primary" @click="showYaml(item.deploymentYaml, $vuetify.lang.t('$vuetify.lang_view_component_deployment_yaml'))">{{ $vuetify.lang.t('$vuetify.lang_menu_view_detail') }}</v-btn>
                        </template>
                        <template v-slot:item.serviceYaml="{ item }">
                          <v-btn v-if="item.serviceYaml" small color="primary" @click="showYaml(item.serviceYaml+item.ingressYaml, $vuetify.lang.t('$vuetify.lang_view_component_service_yaml'))">{{ $vuetify.lang.t('$vuetify.lang_menu_view_detail') }}</v-btn>
                        </template>
                        <template v-slot:item.hpaYaml="{ item }">
                          <v-btn v-if="item.hpaYaml" small color="primary" @click="showYaml(item.hpaYaml, $vuetify.lang.t('$vuetify.lang_view_component_hpa_yaml'))">{{ $vuetify.lang.t('$vuetify.lang_menu_view_detail') }}</v-btn>
                        </template>
                        <template v-slot:item.time="{ item }">
                          {{item.createTime}}<br>{{item.updateTime}}
                        </template>
    ...
    <div class="dialog-box">
      ...
      >
        <v-card>
          <v-card-title>
            <span class="headline">{{$vuetify.lang.t('$vuetify.lang_menu_apply_new_project_envs')}}</span>
          </v-card-title>
          <v-card-text>
            ...
            <div>
              {{$vuetify.lang.t('$vuetify.lang_form_new_project_envs_tip_1', targetProjectName)}}
            </div>
      ...
      >
        <v-card>
          <v-card-title>
            <span class="headline">{{$vuetify.lang.t('$vuetify.lang_menu_apply_delete_project_node_ports')}}</span>
          </v-card-title>
          <v-card-text>
            <v-form ref="nodePortDeleteRef">
              <v-alert icon="mdi-alert-circle" prominent text type="info">
                <small>{{$vuetify.lang.t('$vuetify.lang_form_delete_project_node_ports_prompt')}}</small>
              </v-alert>
              <div>
                {{$vuetify.lang.t('$vuetify.lang_form_delete_project_node_ports_tip_1', targetProjectName, nodePortDeleteForm.envName, nodePortDeleteForm.nodePort)}}
              </div>
              <v-container>
                <v-row>
                  <v-col cols="12">
                    <v-text-field
                      ...
                      required
                      dense
                      v-model="nodePortDeleteForm.title"
                      :rules="[v => !!v || $vuetify.lang.t('$vuetify.lang_form_required')]"
                      :hint="$vuetify.lang.t('$vuetify.lang_form_apply_title_tip_1')"
                      persistent-hint
                    ></v-text-field>
                  ...
                  <v-col cols="12">
                    <v-textarea
                      ...
                      required
                      dense
                      v-model="nodePortDeleteForm.content"
                      :rules="[v => !!v || $vuetify.lang.t('$vuetify.lang_form_required')]"
                      :hint="$vuetify.lang.t('$vuetify.lang_form_apply_content_tip_1')"
                      persistent-hint
                    ></v-textarea>
                  ...
                  <v-col cols="12">
                    <v-file-input
                      ...
                      small-chips
                      show-size
                      v-model="nodePortDeleteAttachment"
                      :hint="$vuetify.lang.t('$vuetify.lang_form_apply_attachments_tip_1')"
                      persistent-hint
                    ></v-file-input>
                  </v-col>
          ...
          <v-card-actions>
            ...
            <v-btn
              ...
              text
              @click="() => {
                this.deleteNodePortDialog = false
                this.$refs.nodePortDeleteRef.reset()
              }"
            >
              {{ $vuetify.lang.t('$vuetify.lang_menu_cancel') }}
            </v-btn>
      ...
      >
        <v-card>
          <v-card-title>
            <span class="headline">{{handleEnvType == 0 ? $vuetify.lang.t('$vuetify.lang_menu_apply_delete_project_envs') : $vuetify.lang.t('$vuetify.lang_menu_apply_delete_project_envs_all')}}</span>
          </v-card-title>
          <v-card-text>
            <v-form ref="envDeleteRef">
              ...
              <div v-if="handleEnvType == 0">
                {{$vuetify.lang.t('$vuetify.lang_form_delete_project_envs_tip_1', targetProjectName, envDeleteForm.envName)}}
              </div>
              <div v-else>
                {{$vuetify.lang.t('$vuetify.lang_form_delete_project_envs_all_tip_1', targetProjectName, envDeleteForm.envName)}}
              </div>
      ...
      >
        <v-card>
          <v-card-title>
            <span class="headline">{{$vuetify.lang.t('$vuetify.lang_menu_apply_new_project_node_ports')}}</span>
          </v-card-title>
          <v-card-text>
            <v-form ref="nodePortAddRef">
              ...
              <div>
                {{$vuetify.lang.t('$vuetify.lang_form_new_project_node_ports_tip_1', targetProjectName, nodePortAddForm.envName)}}
              </div>
              <v-container>
                <v-row>
                  <v-col cols="12">
                  ...
                  <v-col cols="12">
                    <v-textarea
                      ...
                      required
                      dense
                      v-model="nodePortAddForm.content"
                      :rules="[v => !!v || $vuetify.lang.t('$vuetify.lang_form_required')]"
                      :hint="$vuetify.lang.t('$vuetify.lang_form_apply_content_tip_1')"
                      persistent-hint
                    ></v-textarea>
          ...
          <v-card-actions>
            ...
            <v-btn
              ...
              text
              @click="() => {
                this.addNodePortDialog = false
                this.$refs.nodePortAddRef.reset()
              }"
            >
              {{ $vuetify.lang.t('$vuetify.lang_menu_cancel') }}
            </v-btn>
      ...
      >
        <v-card>
          <v-card-title>
            <span class="headline">{{$vuetify.lang.t('$vuetify.lang_menu_apply_update_project')}}</span>
          </v-card-title>
          <v-card-text>
                ...
                <v-row>
                  ...
                  <v-col cols="12">
                    <v-textarea
                      ...
                      required
                      dense
                      v-model="updateProjectForm.content"
                      :rules="[v => !!v || $vuetify.lang.t('$vuetify.lang_form_required')]"
                      :hint="$vuetify.lang.t('$vuetify.lang_form_apply_content_tip_1')"
                      persistent-hint
                    ></v-textarea>
          ...
          <v-card-actions>
            ...
            <v-btn
              ...
              text
              @click="() => {
                this,$refs.updateProjectRef.reset()
      ...
      >
        <v-card>
          <v-card-title>
            <span class="headline">{{$vuetify.lang.t('$vuetify.lang_menu_apply_delete_project')}}</span>
          </v-card-title>
          <v-card-text>
            <v-form ref="deleteProjectRef">
              ...
              <div>
                {{$vuetify.lang.t('$vuetify.lang_form_delete_project_tip_1', targetProjectName)}}
              </div>
              <v-container>
                <v-row>
                  <v-col cols="12">
                  ...
                  <v-col cols="12">
                    <v-text-field
                      ...
                      required
                      dense
                      v-model="deleteProjectForm.title"
                      :rules="[v => !!v || $vuetify.lang.t('$vuetify.lang_form_required')]"
                      :hint="$vuetify.lang.t('$vuetify.lang_form_apply_title_tip_1')"
                      persistent-hint
                    ></v-text-field>
                  ...
                  <v-col cols="12">
                    <v-textarea
                      ...
                      required
                      dense
                      v-model="deleteProjectForm.content"
                      :rules="[v => !!v || $vuetify.lang.t('$vuetify.lang_form_required')]"
                      :hint="$vuetify.lang.t('$vuetify.lang_form_apply_content_tip_1')"
                      persistent-hint
                    ></v-textarea>
      ...
      >
        <v-card>
          <v-card-title>
            <span class="headline">{{$vuetify.lang.t('$vuetify.lang_menu_apply_update_resource_quota')}}</span>
          </v-card-title>
          <v-card-text>
            <v-alert icon="mdi-alert-circle" prominent text type="info">
                  ...
                  <v-row>
                    ...
                    <v-col cols="12">
                      <v-textarea
                        ...
                        required
                        dense
                        v-model="quotaConfigForm.content"
                        :rules="[v => !!v || $vuetify.lang.t('$vuetify.lang_form_required')]"
                        :hint="$vuetify.lang.t('$vuetify.lang_form_apply_content_tip_1')"
                        persistent-hint
                      ></v-textarea>
      ...
      >
        <v-card :loading="dialogLoading">
          <v-card-title>
            {{$vuetify.lang.t('$vuetify.lang_menu_apply_assign_pv')}}
          </v-card-title>
          <v-card-text>
            <v-form ref="allotPVRef">
              <v-alert icon="mdi-alert-circle" prominent text type="info">
                <small>{{$vuetify.lang.t('$vuetify.lang_form_assign_pv_prompt', targetProjectName, addPVForm.envName)}}</small>
              </v-alert>
              <v-container>
                <v-row>
                  <v-col cols="12">
                    <v-autocomplete
                      v-model="addPVForm.pvNames"
                      :items="pvList"
                      multiple
                      dense
                      small-chips
      ...
      >
        <v-card>
          <v-card-title>
            <span class="headline">{{$vuetify.lang.t('$vuetify.lang_menu_apply_remove_pv')}}</span>
          </v-card-title>
          <v-card-text>
...
export default {
  ...
  created () {
    ...
    request.get(`/console/project/${projectName}/branchNames`).then(response => {
  ...
  methods: {
    ...
    refreshList () {
      ...
      request.get(`/console/project/${vm.targetProjectName}/branchNames`).then(response => {
        vm.sourceBranchNames = response.data.branchNames
      }).catch(error => {
        vm.errorTip(true,error.response.data.msg)
      })
    ...
    openNewNodeport(envName) {
      ...
      vm.nodePortAddForm.envName = envName
    },
    newNodePort() {
      const vm = this
    ...
    openRecycleNodeport (envName, nodePort) {
      ...
      vm.nodePortDeleteForm.envName = envName
      vm.nodePortDeleteForm.nodePort = nodePort
    },
    recycleNodeport () {
      const vm =this
    ...
    openRecycleEnv (data) {
      this.envDeleteForm.envName = data
      this.deleteEnvDialog = true
    ...
    openNewEnv(tenantCode) {
      const vm = this
      request.post('/console/envNames/tenantCode', {tenantCode: tenantCode}).then(response => {
    ...
    deleteProject() {
      const vm = this
      if(vm.$refs.deleteProjectRef.validate()){
    ...
    updateToken () {
      const vm = this
      request.post(`/console/project/${vm.targetProjectName}/refreshToken`,vm.updateSecretKeyForm).then(response => {
    ...
    reApplyKubernetes () {
      const vm = this
      request.post(`/console/project/${vm.targetProjectName}/reApply`).then(response => {
    ...
    cleanGitRepo () {
      const vm = this
      request.post(`/console/project/${vm.targetProjectName}/cleanGitRepo`).then(response => {
    ...
    cronAdd () {
      ...
      if(vm.$refs.cronAddRef.validate()){
        request.post(`/console/project/${vm.targetProjectName}/pipelineCronAdd`, vm.addCrontabForm).then(response => {
          vm.successTip(true,response.msg)
    ...
    copyToBranchCrontab () {
      ...
      if(vm.$refs.cronAddRef.validate() && vm.$refs.copyToBranchCrontabRef.validate()){
        ...
        request.post(`/console/project/${vm.targetProjectName}/pipelineCronCopy`, vm.addCrontabForm).then(response => {
          vm.successTip(true,response.msg)
          vm.$refs.cronAddRef.reset()
    ...
    quotaConfig () {
      ...
      if(vm.$refs.quotaConfigRef.validate()){
        if(vm.quotaConfigAttachment.length <= 0){
          request.post(`/console/project/${vm.targetProjectName}/envQuotaConfigUpdate`, vm.quotaConfigForm).then(response => {
          ...
          vm.btnLoading = true
          var formData = new FormData();
          vm.quotaConfigAttachment.forEach(attachment => {
            formData.append('attachment[]', attachment);
          })
          request.post('/console/attachment',formData).then(response => {
            vm.btnLoading = false
            vm.quotaConfigForm.attachmentIDs = response.data.attachmentIDs
            request.post(`/console/project/${vm.targetProjectName}/envQuotaConfigUpdate`, vm.quotaConfigForm).then(response => {
              vm.updateQuotaConfigDialog = false
              vm.successTip(true,response.msg)
              vm.$refs.quotaConfigRef.reset()
    ...
    openAllotPV (envName) {
      const vm = this
      vm.addPVDialog = true
      vm.addPVForm.envName = envName
      vm.dialogLoading = true
      request.get(`/console/env/${envName}/pvNames`).then(response => {
    ...
    allotPV () {
      ...
      if(vm.$refs.allotPVRef.validate()){
        if(vm.addPVAttachment.length <= 0){
          ...
          vm.btnLoading = true
          var formData = new FormData();
          vm.addPVAttachment.forEach(attachment => {
            formData.append('attachment[]', attachment);
          })
          request.post('/console/attachment',formData).then(response => {
            vm.btnLoading = false
    ...
    deletePV () {
      ...
      if(vm.$refs.deletePVRef.validate()){
        if(vm.deletePVAttachment.length <= 0){
          ...
          vm.btnLoading = true
          var formData = new FormData();
          vm.deletePVAttachment.forEach(attachment => {
            formData.append('attachment[]', attachment);
          })
          request.post('/console/attachment',formData).then(response => {
            vm.btnLoading = false
    ...
    addNetworkPolicy () {
      const vm = this
      request.post(`/console/project/${vm.targetProjectName}/envNetworkPolicyAdd`,{
    ...
    deleteNetworkPolicy () {
      ...
      if(vm.$refs.deleteNetworkPolicyRef.validate()){
        if(vm.deleteNetworkPolicyForm.name == vm.confirmValue){
          request.post(`/console/project/${vm.targetProjectName}/envNetworkPolicyDelete`, vm.deleteNetworkPolicyForm).then(response => {
    ...
    allotHost () {
      ...
      if(vm.$refs.addHostRef.validate()){
        ...
        request.post(`/console/project/${vm.targetProjectName}/envHostAdd`, vm.addHostForm).then(response => {
    ...
    hostJoin () {
      ...
      if(vm.$refs.hostJoinRef.validate()){
        ...
        request.post(`/console/project/${vm.targetProjectName}/envHostJoin`, vm.joinHostForm).then(response => {
    ...
    hostLeave () {
      ...
      if(vm.$refs.hostLeaveRef.validate() && vm.leaveHostForm.hostName == vm.confirmValue){
        request.post(`/console/project/${vm.targetProjectName}/envHostLeave`, vm.leaveHostForm).then(response => {
    ...
    dbAdd () {
      ...
      if(vm.$refs.addDbRef.validate()){
        request.post(`/console/project/${vm.targetProjectName}/envDbAdd`, vm.addDbForm).then(response => {
    ...
    dbJoin () {
      ...
      if(vm.$refs.joinDbRef.validate()){
        request.post(`/console/project/${vm.targetProjectName}/envDbJoin`, vm.joinDbForm).then(response => {
    ...
    dbLeave () {
      ...
      if(vm.$refs.leaveDbRef.validate() && vm.leaveDbForm.dbName == vm.confirmValue){
        request.post(`/console/project/${vm.targetProjectName}/envDbLeave`, vm.leaveDbForm).then(response => {
    ...
    deleteDebug () {
      ...
      if(vm.$refs.deleteDebugRef.validate && vm.deleteComponentDebugForm.envName == vm.confirmValue){
        request.post(`/console/project/${vm.targetProjectName}/envComponentDebugDelete`, vm.deleteComponentDebugForm).then(response => {
    ...
    triggerAdd () {
      ...
      if(vm.$refs.triggerAddRef.validate()){
        request.post(`/console/project/${vm.targetProjectName}/pipelineTriggerOp`, vm.addTriggerForm).then(response => {
          vm.successTip(true,response.msg)
    ...
    triggerUpdate () {
      ...
      if(vm.$refs.triggerUpdateRef.validate()){
        request.post(`/console/project/${vm.targetProjectName}/pipelineTriggerOp`, vm.updateTriggerForm).then(response => {
    ...
    copyToBranchTrigger () {
      ...
      if (vm.copyTriggerOpName === 'add') {
        if(vm.$refs.triggerAddRef.validate() && vm.$refs.copyToBranchTriggerRef.validate()){
          ...
          request.post(`/console/project/${vm.targetProjectName}/pipelineTriggerCopy`, vm.addTriggerForm).then(response => {
            vm.successTip(true,response.msg)
            vm.$refs.triggerAddRef.reset()
        ...
        if(vm.$refs.triggerUpdateRef.validate() && vm.$refs.copyToBranchTriggerRef.validate()){
          ...
          request.post(`/console/project/${vm.targetProjectName}/pipelineTriggerCopy`, vm.updateTriggerForm).then(response => {
            vm.successTip(true,response.msg)
            vm.$refs.triggerUpdateRef.reset()
            vm.$refs.copyToBranchTriggerRef.reset()
            vm.refreshList()
    ...
    triggerDelete () {
      const vm = this
      request.post(`/console/project/${vm.targetProjectName}/pipelineTriggerDelete`, vm.deleteTriggerForm).then(response => {
  ...
  computed: {
    ...
    componentHeaders () {
      return [
        ...
        { text: vuetify.preset.lang.t('$vuetify.lang_view_component_deployment_yaml'), value: 'deploymentYaml', sortable: false },
        { text: vuetify.preset.lang.t('$vuetify.lang_view_component_service_yaml'), value: 'serviceYaml', sortable: false },
        { text: vuetify.preset.lang.t('$vuetify.lang_view_component_hpa_yaml'), value: 'hpaYaml', sortable: false },
        { text: vuetify.preset.lang.t('$vuetify.lang_view_debug_component_create_update_time'), value: 'time', sortable: false },
        { text: vuetify.preset.lang.t('$vuetify.lang_view_operations'), value: 'handle', sortable: false },
      ]
    },
