<template>
  <page-card :name="$vuetify.lang.t('$vuetify.lang_menu_metrics_scan_codes')">
    <v-card-text>
      <v-tabs v-model="tabValue">
        <v-tab>{{$vuetify.lang.t('$vuetify.lang_view_metrics_scan_codes_count')}}</v-tab>
        <v-tab @change="change2()">{{$vuetify.lang.t('$vuetify.lang_view_metrics_scan_codes_duration')}}</v-tab>
        <v-tab @change="change3()">{{$vuetify.lang.t('$vuetify.lang_view_metrics_scan_codes_weekly')}}</v-tab>
        <v-tab @change="change4()">{{$vuetify.lang.t('$vuetify.lang_view_metrics_scan_codes_status_rate')}}</v-tab>
      </v-tabs>
          ...
          <v-form>
            <v-container class="d-flex flex-wrap">
              ...
              <v-autocomplete
                ...
                small-chips
                multiple
                v-model="chartParams2.scanCodeResults"
                @change="getEcharts2()"
              ></v-autocomplete>
            </v-container>
          </v-form>
          ...
          <v-form>
            <v-container class="d-flex flex-wrap">
              ...
              <v-autocomplete
                ...
                small-chips
                multiple
                v-model="chartParams3.scanCodeResults"
                @change="getEcharts3()"
              ></v-autocomplete>
            </v-container>
          </v-form>
            ...
            <v-container class="d-flex flex-wrap">
              <v-autocomplete
                :items="[
                  ...
                  { text: $vuetify.lang.t('$vuetify.lang_form_metrics_dimension_scan_code_result'), value: 'scanCodeResult' },
                ]"
                :label="$vuetify.lang.t('$vuetify.lang_form_metrics_dimension')"
                class="mr-8"
                dense
              ...
              <v-autocomplete
                ...
                small-chips
                multiple
                v-model="chartParams4.scanCodeResults"
                @change="getEcharts4()"
              ></v-autocomplete>
            </v-container>
          </v-form>
...
export default {
  ...
  data () {
    return {
      ...
      dimensionList: [
        ...
        { text: vuetify.preset.lang.t('$vuetify.lang_form_metrics_dimension_scan_code_result'), value: 'scanCodeResult' },
      ],
      timeZoomList: [
  ...
  created () {
    const vm = this
    request.get('/metrics/scanCodes/options').then(response => {
      ...
      vm.scanCodeResultsList = response.data.scanCodeResults
    })
  },
  mounted () {
    const vm = this
    ...
    request.post('/metrics/scanCodes/count', vm.chartParams).then(response => {
      vm.config = {
        type: 'line',
        data: {
  ...
  methods: {
    ...
    getEcharts2 () {
      ...
      if(vm.chartParams2.timeRangeDays == 0 && vm.dates2.length == 0){
        ...
        request.post('/metrics/scanCodes/duration', vm.chartParams2).then(response => {
          vm.config2 = {
            type: 'line',
            data: {
              labels: response.data.labels,
    ...
    getEcharts3 () {
      ...
      if(vm.chartParams3.timeRangeDays == 0 && vm.dates3.length == 0){
        ...
        request.post('/metrics/scanCodes/countWeekly', vm.chartParams3).then(response => {
          vm.config3 = {
            type: 'line',
            data: {
              labels: response.data.labels,
    ...
    getEcharts4 () {
      ...
      if(vm.chartParams4.timeRangeDays == 0 && vm.dates4.length == 0){
        ...
        vm.statusResultsList.map((item,index) => {
          ...
          request.post(`/metrics/scanCodes/status/${item}`, vm.chartParams4).then(response => {
            vm.config4[index] = {
              type: 'line',
              data: {
                labels: response.data.labels,
