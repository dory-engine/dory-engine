<template>
  <page-card :name="$vuetify.lang.t('$vuetify.lang_menu_metrics_steps')">
    <v-card-text>
      <v-tabs v-model="tabValue">
        <v-tab>{{$vuetify.lang.t('$vuetify.lang_view_metrics_steps_count')}}</v-tab>
        <v-tab @change="change2()">{{$vuetify.lang.t('$vuetify.lang_view_metrics_steps_duration')}}</v-tab>
        <v-tab @change="change3()">{{$vuetify.lang.t('$vuetify.lang_view_metrics_steps_weekly')}}</v-tab>
        <v-tab @change="change4()">{{$vuetify.lang.t('$vuetify.lang_view_metrics_steps_status_rate')}}</v-tab>
      </v-tabs>
          ...
          <v-form>
            <v-container class="d-flex flex-wrap">
              ...
              <v-autocomplete
                ...
                :label="$vuetify.lang.t('$vuetify.lang_form_metrics_filter_by_module_type')"
                class="mr-8"
                dense
                small-chips
                multiple
            ...
            <v-container class="d-flex flex-wrap">
              <v-autocomplete
                :items="[
                  ...
                  { text: $vuetify.lang.t('$vuetify.lang_form_metrics_dimension_module_type'), value: 'moduleType' },
                  { text: $vuetify.lang.t('$vuetify.lang_form_metrics_dimension_module_name'), value: 'moduleName' },
                  { text: $vuetify.lang.t('$vuetify.lang_form_metrics_dimension_step_action'), value: 'stepAction' },
                ]"
                :label="$vuetify.lang.t('$vuetify.lang_form_metrics_dimension')"
                class="mr-8"
                dense
  ...
  data () {
    return {
      ...
      dimensionList: [
        ...
        { text: vuetify.preset.lang.t('$vuetify.lang_form_metrics_dimension_module_type'), value: 'moduleType' },
        { text: vuetify.preset.lang.t('$vuetify.lang_form_metrics_dimension_module_name'), value: 'moduleName' },
        { text: vuetify.preset.lang.t('$vuetify.lang_form_metrics_dimension_step_action'), value: 'stepAction' },
      ],
      timeZoomList: [
