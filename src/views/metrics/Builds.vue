<template>
  <page-card :name="$vuetify.lang.t('$vuetify.lang_menu_metrics_builds')">
    <v-card-text>
      <v-tabs v-model="tabValue">
        <v-tab>{{ $vuetify.lang.t('$vuetify.lang_view_metrics_builds_count') }}</v-tab>
        <v-tab @change="change2()">{{ $vuetify.lang.t('$vuetify.lang_view_metrics_builds_duration') }}</v-tab>
        <v-tab @change="change3()">{{ $vuetify.lang.t('$vuetify.lang_view_metrics_builds_weekly') }}</v-tab>
        <v-tab @change="change4()">{{ $vuetify.lang.t('$vuetify.lang_view_metrics_builds_status_rate') }}</v-tab>
      </v-tabs>
            ...
            <v-container class="d-flex flex-wrap">
              <v-autocomplete
                :items="[
                  ...
                  { text: $vuetify.lang.t('$vuetify.lang_form_metrics_dimension_build_env'), value: 'buildEnv' },
                ]"
                :label="$vuetify.lang.t('$vuetify.lang_form_metrics_dimension')"
                class="mr-8"
                dense
  ...
  data () {
    return {
      ...
      dimensionList: [
        ...
        { text: vuetify.preset.lang.t('$vuetify.lang_form_metrics_dimension_build_env'), value: 'buildEnv' },
      ],
      timeZoomList: [
