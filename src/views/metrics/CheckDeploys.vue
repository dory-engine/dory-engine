<template>
  <page-card :name="$vuetify.lang.t('$vuetify.lang_menu_metrics_check_deploys')">
    <v-card-text>
      <v-tabs v-model="tabValue">
        <v-tab>{{$vuetify.lang.t('$vuetify.lang_view_metrics_check_deploys_count')}}</v-tab>
        <v-tab @change="change2()">{{$vuetify.lang.t('$vuetify.lang_view_metrics_check_deploys_duration')}}</v-tab>
        <v-tab @change="change3()">{{$vuetify.lang.t('$vuetify.lang_view_metrics_check_deploys_weekly')}}</v-tab>
        <v-tab @change="change4()">{{$vuetify.lang.t('$vuetify.lang_view_metrics_check_deploys_status_rate')}}</v-tab>
      </v-tabs>
          ...
          <v-form>
            <v-container class="d-flex flex-wrap">
              ...
              <v-autocomplete
                ...
                :label="$vuetify.lang.t('$vuetify.lang_form_metrics_filter_by_deployment_status')"
                class="mr-8"
                dense
                small-chips
                multiple
            ...
            <v-container class="d-flex flex-wrap">
              <v-autocomplete
                :items="[
                  ...
                  { text: $vuetify.lang.t('$vuetify.lang_form_metrics_dimension_deployment_status'), value: 'deploymentStatus' },
                ]"
                :label="$vuetify.lang.t('$vuetify.lang_form_metrics_dimension')"
                class="mr-8"
                dense
  ...
  data () {
    return {
      ...
      dimensionList: [
        ...
        { text: vuetify.preset.lang.t('$vuetify.lang_form_metrics_dimension_deployment_status'), value: 'deploymentStatus' },
      ],
      timeZoomList: [
