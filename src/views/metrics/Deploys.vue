<template>
  <page-card :name="$vuetify.lang.t('$vuetify.lang_menu_metrics_deploy_containers')">
    <v-card-text>
      <v-tabs v-model="tabValue">
        <v-tab>{{ $vuetify.lang.t('$vuetify.lang_view_metrics_deploy_containers_count') }}</v-tab>
        <v-tab @change="change2()">{{ $vuetify.lang.t('$vuetify.lang_view_metrics_deploy_containers_duration') }}</v-tab>
        <v-tab @change="change3()">{{ $vuetify.lang.t('$vuetify.lang_view_metrics_deploy_containers_weekly') }}</v-tab>
        <v-tab @change="change4()">{{ $vuetify.lang.t('$vuetify.lang_view_metrics_deploy_containers_status_rate') }}</v-tab>
      </v-tabs>
          ...
          <v-form>
            <v-container class="d-flex flex-wrap">
              ...
              <v-select
                ...
                :label="$vuetify.lang.t('$vuetify.lang_form_metrics_filter_by_is_mesh_enable')"
                class="mr-8"
                dense
                small-chips
                multiple
            ...
            <v-container class="d-flex flex-wrap">
              <v-select
                :items="[
                  ...
                  { text: $vuetify.lang.t('$vuetify.lang_form_metrics_dimension_is_mesh_enable'), value: 'isMeshEnable' },
                ]"
                :label="$vuetify.lang.t('$vuetify.lang_form_metrics_dimension')"
                class="mr-8"
                dense
  ...
  data () {
    return {
      ...
      dimensionList: [
        ...
        { text: vuetify.preset.lang.t('$vuetify.lang_form_metrics_dimension_is_mesh_enable'), value: 'isMeshEnable' },
      ],
      timeZoomList: [
