<template>
  <page-card :name="$vuetify.lang.t('$vuetify.lang_menu_metrics_packages')">
    <v-card-text>
      <v-tabs v-model="tabValue">
        <v-tab>{{$vuetify.lang.t('$vuetify.lang_view_metrics_packages_count')}}</v-tab>
        <v-tab @change="change2()">{{$vuetify.lang.t('$vuetify.lang_view_metrics_packages_duration')}}</v-tab>
        <v-tab @change="change3()">{{$vuetify.lang.t('$vuetify.lang_view_metrics_packages_weekly')}}</v-tab>
        <v-tab @change="change4()">{{$vuetify.lang.t('$vuetify.lang_view_metrics_packages_status_rate')}}</v-tab>
        <v-tab @change="change5()">{{$vuetify.lang.t('$vuetify.lang_view_metrics_packages_average_size')}}</v-tab>
        <v-tab @change="change6()">{{$vuetify.lang.t('$vuetify.lang_view_metrics_packages_total_size')}}</v-tab>
      </v-tabs>
