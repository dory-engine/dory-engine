<template>
  <page-card :name="$vuetify.lang.t('$vuetify.lang_menu_metrics_runs')">
    <v-card-text>
      <v-tabs v-model="tabValue">
        <v-tab>{{ $vuetify.lang.t('$vuetify.lang_view_metrics_runs_count') }}</v-tab>
        <v-tab @change="change2()">{{ $vuetify.lang.t('$vuetify.lang_view_metrics_runs_duration') }}</v-tab>
        <v-tab @change="change3()">{{ $vuetify.lang.t('$vuetify.lang_view_metrics_runs_weekly') }}</v-tab>
        <v-tab @change="change4()">{{ $vuetify.lang.t('$vuetify.lang_view_metrics_runs_status_rate') }}</v-tab>
        <v-tab @change="change5()">{{ $vuetify.lang.t('$vuetify.lang_view_metrics_runs_fixruns_duration') }}</v-tab>
      </v-tabs>
        ...
        <v-tab-item>
          <v-form>
            <v-container class="d-flex flex-wrap">
              ...
              ></v-autocomplete>
              <v-autocomplete
                :items="triggerKindsList"
                :label="$vuetify.lang.t('$vuetify.lang_form_metrics_filter_by_trigger_kind')"
                class="mr-8"
                dense
                small-chips
                multiple
                v-model="chartParams.triggerKinds"
                @change="getEcharts()"
              ></v-autocomplete>
            </v-container>
          </v-form>
          ...
          <v-form>
            <v-container class="d-flex flex-wrap">
              ...
              <v-autocomplete
                ...
                small-chips
                multiple
                v-model="chartParams2.triggerKinds"
                @change="getEcharts2()"
              ></v-autocomplete>
            </v-container>
          </v-form>
          ...
          <v-form>
            <v-container class="d-flex flex-wrap">
              ...
              <v-autocomplete
                ...
                small-chips
                multiple
                v-model="chartParams3.triggerKinds"
                @change="getEcharts3()"
              ></v-autocomplete>
            </v-container>
          </v-form>
          ...
          <v-form>
            <v-container class="d-flex flex-wrap">
              ...
              <v-autocomplete
                ...
                small-chips
                multiple
                v-model="chartParams5.triggerKinds"
                @change="getEcharts5()"
              ></v-autocomplete>
            </v-container>
          </v-form>
...
export default {
  ...
  data () {
    return {
      ...
      dimensionList: [
        ...
        { text: vuetify.preset.lang.t('$vuetify.lang_form_metrics_dimension_trigger_kind'), value: 'triggerKind' },
      ],
      timeZoomList: [
  ...
  created () {
    ...
    request.get('/metrics/runs/options').then(response => {
      ...
      vm.triggerKindsList = response.data.triggerKinds
    })
  },
  mounted () {
    const vm = this
