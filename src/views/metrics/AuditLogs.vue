<template>
  <page-card :name="$vuetify.lang.t('$vuetify.lang_menu_metrics_audit_logs')">
    <v-card-text>
      <v-tabs v-model="tabValue">
        <v-tab>{{$vuetify.lang.t('$vuetify.lang_view_metrics_audit_logs_count')}}</v-tab>
        <v-tab @change="change2()">{{$vuetify.lang.t('$vuetify.lang_view_metrics_audit_logs_duration')}}</v-tab>
        <v-tab @change="change3()">{{$vuetify.lang.t('$vuetify.lang_view_metrics_audit_logs_weekly')}}</v-tab>
        <v-tab @change="change4()">{{$vuetify.lang.t('$vuetify.lang_view_metrics_audit_logs_status_rate')}}</v-tab>
      </v-tabs>
        ...
        <v-tab-item>
          <v-form>
            <v-container class="d-flex flex-wrap">
              ...
              <v-autocomplete
                :items="usernamesList"
                :label="$vuetify.lang.t('$vuetify.lang_form_metrics_filter_by_username')"
                class="mr-8"
                dense
                small-chips
                multiple
              ...
              <v-autocomplete
                :items="opTypesList"
                :label="$vuetify.lang.t('$vuetify.lang_form_metrics_filter_by_step_action')"
                class="mr-8"
                dense
                small-chips
                multiple
              ...
              <v-autocomplete
                ...
                :label="$vuetify.lang.t('$vuetify.lang_form_metrics_filter_by_with_admin_log')"
                class="mr-8"
                dense
                small-chips
                multiple
            ...
            <v-container class="d-flex flex-wrap">
              <v-autocomplete
                :items="[
                  ...
                  { text: $vuetify.lang.t('$vuetify.lang_form_metrics_dimension_username'), value: 'username' },
                  { text: $vuetify.lang.t('$vuetify.lang_form_metrics_dimension_operate_type'), value: 'opType' },
                  { text: $vuetify.lang.t('$vuetify.lang_form_metrics_dimension_with_admin_log'), value: 'withAdminLog' },
                ]"
                :label="$vuetify.lang.t('$vuetify.lang_form_metrics_dimension')"
                class="mr-8"
                dense
  ...
  data () {
    return {
      ...
      dimensionList: [
        ...
        { text: vuetify.preset.lang.t('$vuetify.lang_form_metrics_dimension_username'), value: 'username' },
        { text: vuetify.preset.lang.t('$vuetify.lang_form_metrics_dimension_status_result'), value: 'statusResult' },
        { text: vuetify.preset.lang.t('$vuetify.lang_form_metrics_dimension_operate_type'), value: 'opType' },
        { text: vuetify.preset.lang.t('$vuetify.lang_form_metrics_dimension_with_admin_log'), value: 'withAdminLog' },
      ],
      timeZoomList: [
