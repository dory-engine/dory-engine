<template>
  <page-card :name="$vuetify.lang.t('$vuetify.lang_menu_metrics_commits')">
    <v-card-text>
      <v-tabs v-model="tabValue">
        <v-tab>{{$vuetify.lang.t('$vuetify.lang_view_metrics_commits_count')}}</v-tab>
        <v-tab @change="change2()">{{$vuetify.lang.t('$vuetify.lang_view_metrics_commits_lines_count')}}</v-tab>
        <v-tab @change="change3()">{{$vuetify.lang.t('$vuetify.lang_view_metrics_commits_weekly')}}</v-tab>
        <v-tab @change="change4()">{{$vuetify.lang.t('$vuetify.lang_view_metrics_commits_lines_weekly')}}</v-tab>
      </v-tabs>
          ...
          <v-form>
            <v-container class="d-flex flex-wrap">
              ...
              <v-autocomplete
                ...
                :label="$vuetify.lang.t('$vuetify.lang_form_metrics_filter_by_committee_name')"
                class="mr-8"
                dense
                small-chips
                multiple
              ...
              <v-autocomplete
                ...
                :label="$vuetify.lang.t('$vuetify.lang_form_metrics_filter_by_committee_mail')"
                class="mr-8"
                dense
                small-chips
                multiple
  ...
  data () {
    return {
      ...
      dimensionList: [
        ...
        { text: vuetify.preset.lang.t('$vuetify.lang_form_metrics_dimension_committee_name'), value: 'committerName' },
        { text: vuetify.preset.lang.t('$vuetify.lang_form_metrics_dimension_committee_mail'), value: 'committerEmail' },
      ],
      timeZoomList: [
