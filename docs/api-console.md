...
- [api/console接口文档](#apiconsole接口文档)
  ...
  - [api接口](#api接口)
    - [console 项目控制台接口](#console-项目控制台接口)
      ...
      - [\[GET\] api/console/projectDescs console项目全称列表接口，用于搜索的下拉列表](#get-apiconsoleprojectdescs-console项目全称列表接口用于搜索的下拉列表)
...
#### [GET] api/console/projectDescs console项目全称列表接口，用于搜索的下拉列表
