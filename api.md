...
- [接口文档](#接口文档)
  ...
  - [api接口](#api接口)
    ...
    - [cicd 持续交付接口](docs/api-cicd.md#cicd-持续交付接口)
      ...
      - [\[GET\] api/cicd/projectDescs cicd项目全称列表接口，用于搜索的下拉列表](docs/api-cicd.md#get-apicicdprojectdescs-cicd项目全称列表接口用于搜索的下拉列表)
    ...
    - [admin 管理控制台接口](docs/api-admin.md#admin-管理控制台接口)
      ...
      - [\[GET\] api/admin/projectDescs admin项目全称列表接口，用于搜索的下拉列表](docs/api-admin.md#get-apiadminprojectdescs-admin项目全称列表接口用于搜索的下拉列表)
    ...
    - [console 项目控制台接口](docs/api-console.md#console-项目控制台接口)
      ...
      - [\[GET\] api/console/projectDescs console项目全称列表接口，用于搜索的下拉列表](docs/api-console.md#get-apiconsoleprojectdescs-console项目全称列表接口用于搜索的下拉列表)
